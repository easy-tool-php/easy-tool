...
|[PSR-14](https://www.php-fig.org/psr/psr-14/)|Event Dispatcher|Implements `Psr\EventDispatcher\EventDispatcherInterface`<br/>`Psr\EventDispatcher\ListenerProviderInterface`|
